...
model = whisper.load_model('medium')  # Use 'large' for better accuracy if needed

# Initialize MemGPT Agent
agent = Agent(
    model_name='llama2-uncensored:latest',  # Replace with your model name
    model_endpoint='http://localhost:11434',  # Ollama endpoint
